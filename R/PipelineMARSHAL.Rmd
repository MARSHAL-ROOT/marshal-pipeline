...
```{r , warning= F, echo=F, fig.pos="!h", fig.cap= "Axial conductance on axes and lateral root type", fig.height= 2.5}
...
```{r BC Kr, warning= F, echo= F, fig.cap= "Radial conductivity on axes and lateral root type", fig.height= 2.5}
...
```{r , echo = F, fig.cap="Area of the convex hull for the different root system architecture examples. (left) superposition of all the convex hull repetitions. (right) area in square meter of each convex hull. $\\bigtriangleup$ = Postma 2011, $\\square$ = Leitner 2014, and $\\bigcirc$ = Leitner 2010 RSA example" , fig.pos = "!h", out.width='.49\\linewidth', fig.width=3, fig.height=3,fig.show='hold',fig.align='center'}
pol_ch%>%
  ggplot()+
  theme_classic()+
  coord_fixed() +
